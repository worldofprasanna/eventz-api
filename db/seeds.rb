conference = Conference.create(title: 'Hello World Conference', description: 'This is the first conference being created in the system', location: 'Bangalore', image_url: 'some_url', start_date: Time.now)
